...
st.markdown("""
|FIELD1|FIRST_NAME|LAST_NAME|2023_ORDER|SCORE|SCALED_ORDER|SCALED_SCORE|TOTAL |
|------|----------|---------|----------|-----|------------|------------|------|
|0     |Andrew    |Frazier  |8         |0    |1.0         |0.0         |1.000 |
|1     |Brian     |Scanen   |6         |0    |0.714       |0.0         |0.714 |
|2     |John      |Wholihan |4         |0    |0.429       |0.0         |0.429 |
|6     |Chris     |Vienneau |7         |67   |0.857       |0.519       |0.337 |
|3     |Will      |Cokeley  |2         |0    |0.143       |0.0         |0.143 |
|7     |Brian     |Roepke   |5         |129  |0.571       |1.0         |-0.429|
|5     |Alexander |O'Brien  |3         |105  |0.286       |0.814       |-0.528|
|4     |Chrissy   |Roepke   |1         |86   |0.0         |0.667       |-0.667|
""")
